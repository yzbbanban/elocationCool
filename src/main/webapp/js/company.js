        ...
        $("#regist_company_btn").click(function () {
            ...
            $.ajax({
                ...
                data: {
                    "userId": userId,
                    "coolCompanyId": "0",
                    "coolCompanyName": name,
                    "coolCompanyEmail": email,
                    "coolCompanyAddress": address,
                    "coolCompanyTel": tel
                },
                dataType: "json",
            ...
            success: function (result) {
                if (result.code == "10000") {
                    if (result.result != null) {
                        ...
                        $("#company_name").text(result.result.coolCompanyName);
                        $("#company_email").text(result.result.coolCompanyEmail);
                        $("#company_address").text(result.result.coolCompanyAddress);
                        $("#company_tel").text(result.result.coolCompanyTel);
                        // 创建公司按钮消失
