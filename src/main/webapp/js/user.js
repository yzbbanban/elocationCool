...
//				 alert(result.result.nick);
                addCookie("userId", result.result.coolUserId, 2);
                addCookie("nick", result.result.coolUserNick, 2);
                addCookie("companyId", result.result.coolCompanyId, 2);
//				alert(result.result.userLevel);
                addCookie("level", result.result.coolUserLevel, 2);
                // 进如主页
...
function registAction() {
    if (checkName() && checkPassword() && checkConfirm() && checkRegistPassword() && checkRegistName()) {
